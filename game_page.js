...
document.getElementById("player_1_question").innerHTML =  "Question Turn - " + player1_name;
document.getElementById("player_2_answer").innerHTML = "Answer Turn - " + player2_name;
